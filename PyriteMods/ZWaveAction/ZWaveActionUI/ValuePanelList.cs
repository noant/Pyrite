...
namespace OZWForm
{
    ...
    public class ValuePanelList: ValuePanel
    {
        ...
        public ValuePanelList( ZWValueID valueID ): base( valueID )
        {
            ...
            ValueListLabel.Text = Manager.GetValueLabel(valueID);
            ...
            String[] items;
            if (Manager.GetValueListItems(valueID, out items))
            {
            ...
            String value;
            if (Manager.GetValueListSelection(valueID, out value))
            {
        ...
        private void ValueListComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (SendChanges)
            {
                Manager.SetValueListSelection(ValueID, ValueListComboBox.Text);
            }
        }
    }
}
