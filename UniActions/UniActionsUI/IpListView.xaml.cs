...
namespace UniActionsUI
{
    ...
    public partial class IpListView : UserControl, ControlsHelper.IRefreshable, ControlsHelper.IConfirm
    {
        ...
        public void Refresh()
        {
            bsResolveAllIp.Value = App.Uni.ServerThreading.Settings.ResolveAllIp;
            _tempList = new SkeddedList<IPAddress>();
            _tempList.AddRange(App.Uni.ServerThreading.Settings.ResolvedIp);
            listIp.Items.Clear();
        ...
        public void Confirm()
        {
            App.Uni.ServerThreading.Settings.ResolveAllIp = bsResolveAllIp.Value;
            App.Uni.ServerThreading.Settings.ResolvedIp.Clear();
            App.Uni.ServerThreading.Settings.ResolvedIp.AddRange(_tempList);
        }
